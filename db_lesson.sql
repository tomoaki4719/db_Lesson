...
UPDATE people SET department_id = '3' WHERE person_id IN (8);
UPDATE people SET department_id = '4' WHERE person_id IN (9);
UPDATE people SET department_id = '5' WHERE person_id IN (10);
-- Q5
